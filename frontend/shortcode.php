...
function sc_loc_frontend_shortcode() {
    ...
    <div class="sc-loc-frontend">
        ...
        <p>
            ...
            <small><?php printf( esc_html__( 'Credit to %s for the contracts and ordinance work.', 'sc-localization' ), '<a href="https://github.com/MrKraken/StarStrings/">MrKrakken</a>' ); ?></small><br/>
            <small><a href="https://github.com/ulrichdahl/WP-StarStrings" target="_blank">Github Repository</a></small><br/>
        </p>
    </div>
    <?php
    return ob_get_clean();
